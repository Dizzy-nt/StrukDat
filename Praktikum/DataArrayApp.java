...
public class DataArrayApp {
    public static void main(String[] args) {
        ...
        arr.insert(16650220, "Ahmad", "Sidoarjo");
        arr.insert(16650230, "Ismail", "Banyuwangi");
        arr.insert(16650240, "Sofi", "Semarang");
        arr.insert(16650250, "Dinda", "Bandung");
        arr.insert(16650260, "Rais", "Ambon");
        arr.insert(16650270, "Helmi", "Madura");
        ...
        if (mhs!=null) {
            ...
            System.out.println("NIM "+searchKey+" ga ketemu :(");
        }
        searchKey=16650240;
        System.out.println("\nHapus NIM : "+searchKey);
